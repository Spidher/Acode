...
def post_delete(tweet_id):
  # Construct the correct URL with the tweet ID
  d_url = f'https://api.twitter.com/2/tweets/{int(tweet_id)}'
  
  # Make the delete request with OAuth authentication
